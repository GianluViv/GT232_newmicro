...
//11585465/2043637/2.50/17/3/Integrated Circuit
...
(library Library_1
	...
	(patternDef "QFN50P300X300X60-17N" (originalName "QFN50P300X300X60-17N")
		(multiLayer
	...
	(symbolDef "CY8C4014LQI-421" (originalName "CY8C4014LQI-421")
	...
	(compDef "CY8C4014LQI-421" (originalName "CY8C4014LQI-421") (compHeader (numPins 17) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "P0.1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "P0.2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "P0.4") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "VCCD") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "8" (pinName "P0.6") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "12" (pinName "P1.6") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "11" (pinName "P1.3") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "10" (pinName "P1.2") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "9" (pinName "P1.1") (partNum 1) (symPinNum 12) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "17" (pinName "EP") (partNum 1) (symPinNum 13) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "16" (pinName "P3.2") (partNum 1) (symPinNum 14) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "15" (pinName "P3.1") (partNum 1) (symPinNum 15) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "14" (pinName "P3.0") (partNum 1) (symPinNum 16) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "13" (pinName "P1.7") (partNum 1) (symPinNum 17) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "CY8C4014LQI-421"))
		(attachedPattern (patternNum 1) (patternName "QFN50P300X300X60-17N")
			(numPads 17)
			(padPinMap
		...
		(attr "Manufacturer_Part_Number" "CY8C4014LQI-421")
		(attr "Mouser Part Number" "727-CY8C4014LQI-421")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Cypress-Semiconductor/CY8C4014LQI-421?qs=h2odU9YHRxyINW4X3fOvRg%3D%3D")
		(attr "Arrow Part Number" "")
		(attr "Arrow Price/Stock" "")
		(attr "Description" "Cypress Semiconductor CY8C4014LQI-421, 32bit Microcontroller, CY8C4014, 16MHz, 16 kB Flash, 16-Pin QFN")
		(attr "<Hyperlink>" "http://uk.rs-online.com/web/p/products/1783282")
		(attr "<Component Height>" "0.6")
		(attr "<STEP Filename>" "CY8C4014LQI-421.stp")
